...
#' @family classes
#' @concept custom_filters
GLSFilterSettingsList <- R6::R6Class(
...
#' Read Filter File
#'
#' Read filter settings from an Excel or CSV file and return as a GLSFilterSettingsList object.
...
#' @return A GLSFilterSettingsList object containing the filter settings.
#' @concept custom_filters
#' @export
read_filter_file <- function(filepath) {
    ...
    GLSFilterSettingsList$new(filter_list)
}
...
#' @concept custom_filters
#' @export
create_filter_settings_file <- function(filepath, species = c()) {
